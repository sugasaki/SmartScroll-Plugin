========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : test
========================================================================


AppWizard が生成した test には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには test を構成している各ファイルの概要説明が含まれています。
...
test.h
    ...
    みます） をインクルードし、また CTestApp アプリケーションクラスを宣
    言します。

test.cpp
    このファイルは CTestApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\test.ico
    ...
    ルです。このアイコンはリソース ファイル test.rc によってインクルード
    されます。
...
testDlg.h, testDlg.cpp - ダイアログ
    これらのファイルは CTestDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な test.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) test.pch 
