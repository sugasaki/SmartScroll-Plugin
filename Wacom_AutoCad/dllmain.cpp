...
SspApplyProc(HWND hWnd)
{
	...
	if(!_strnicmp(szClass, "AutoCAD 2004 - [", 16)) acadFlag = true;
	if(!_strnicmp(szClass, "AutoCAD 2002 - [", 16)) acadFlag = true;
	if(!_strnicmp(szClass, "AutoCAD 2000 - [", 16)) acadFlag = true;
	if(!_strnicmp(szClass, "AutoCAD 2000i - [", 17)) acadFlag = true;
